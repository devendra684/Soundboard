              ...
              <CardContent>
                <div className="flex flex-col items-center gap-4">
                  ...
                  <div className="flex flex-col gap-3 w-full">
                    <Input placeholder="Enter room code" className="h-12 rounded-lg bg-background/80 text-foreground shadow-inner px-5" />
                    <Button className="h-12 rounded-lg bg-gradient-to-r from-[#ff6a00] to-[#ffb347] text-white shadow-lg hover:scale-105 transition-transform">Join Room</Button>
                  </div>
                </div>
              </CardContent>
            </Card>
